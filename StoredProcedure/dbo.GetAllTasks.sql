...
AS
	Select t.TaskID,u.UserID,ts.TaskStatusName,tt.TaskTypeName, c.Comment,ct.CommentTypeName,t.TaskDescription, CONCAT(u.FirstName,' ',u.LastName) as AssignedTo,t.NextActionDate FROM dbo.Task t
